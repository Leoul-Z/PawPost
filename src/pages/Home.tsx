...
<section className="relative w-full min-h-[700px] flex items-center overflow-hidden bg-[#fdfbf7] pt-12 md:pt-0">
  ...
  <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">

    <div className="flex flex-col items-start pt-8 pb-16 md:py-16">
      ...
      <h1 className="font-display-lg text-[48px] md:text-[64px] leading-[1.1] text-[#1e1e1e] mb-6 font-bold tracking-tight text-balance">
